      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="mb-8">
              <motion.h2 
                className="text-4xl md:text-5xl lg:text-6xl font-black text-dark-900 mb-6 leading-tight tracking-wide"
              ...
              <motion.p 
                className="text-base md:text-lg text-dark-600 mb-6 leading-relaxed"
                initial={{ opacity: 0 }}
              ...
              <div className="mb-8">
                <motion.h3 
                  className="text-2xl md:text-3xl font-black text-dark-900 mb-2 tracking-wide"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  viewport={{ once: true }}
                ...
                <motion.h3 
                  className="text-2xl md:text-3xl font-black text-accent-600 tracking-wide"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  viewport={{ once: true }}
              ...
              <motion.div 
                className="flex items-center gap-2 sm:gap-4 flex-nowrap whitespace-nowrap overflow-x-auto"
