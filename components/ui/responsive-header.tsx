    ...
    <DrawerContext.Provider value={{ open, setOpen }}>
      <>
        ...
        >
          ...
          <VaulHeader.Portal>
            <VaulHeader.Overlay className='fixed inset-0 dark:bg-black/40 bg-black/50 backdrop-blur-sm z-50' />
            <VaulHeader.Content className='bg-[#000000] border-b border-white/10 z-50 w-full h-fit py-3 fixed top-0 left-0'>
              {children}
            </VaulHeader.Content>
          </VaulHeader.Portal>
        </VaulHeader.Root>
